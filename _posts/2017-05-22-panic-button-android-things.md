...
author: robertoestivill
---

[Panic Button][link2] is an Android application targeting Android Things that integrates with Twilio to deliver SMS's or phone calls to a configured phone number when a physical button is pressed.
...
It was super fun to work on a project that involves physical things and can not wait to play more. 
I hope you find this project as interesting and educational as I did.
